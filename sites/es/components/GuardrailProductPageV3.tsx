      ...
      <main ref={pageRef} className={styles.page} style={pageStyle}>
        ...
        <section className={styles.caseSection} id="applications">
          ...
          <div className={styles.caseHeading} data-polish-reveal>
            <h2>From receiving<br />to dispatch.</h2>
        ...
        <section className={styles.articleSection} id="articles">
          <div className={styles.articleIntro} data-polish-reveal>
            <h2>Field notes for<br />better weighing.</h2>
        ...
        <section className={styles.ctaSection} id="project-quote">
          <div className={styles.ctaCopy} data-polish-reveal>
            <div className={styles.sectionLine}><span>05</span><i /></div>
            <h2>Build the right scale<br />for your workflow.</h2>
            <p>Send your capacity, platform size and working conditions. Our engineers will prepare a matched configuration.</p>
            <Link className={styles.primaryButton} href="/request-a-quote">
              Request a project quote <ArrowRight size={18} />
            </Link>
          </div>
          <div className={styles.blueprint} aria-label="Guardrail platform scale configuration summary" data-polish-reveal>
            <Image src="/media/guardrail-turntable/angle-000.png" alt="Front view of Guardrail Platform Scale" fill sizes="(max-width: 800px) 84vw, 38vw" />
            <span className={styles.blueprintWidth}><i />40–60 cm<i /></span>
            <span className={styles.blueprintHeight}><i />Configured height<i /></span>
          </div>
        </section>
      </main>
      <SiteFooter />
