    ...
    >
      <div className="header-inner">
        ...
        <div className="nav-stage">
          <nav className="desktop-nav locale-fixed" aria-label="Navegación principal">
            <Link className={isActive("/") ? "current" : ""} href="/" onClick={() => setActiveMenu(null)}>Inicio</Link>
            ...
            <Link className={isActive("/about") ? "current" : ""} href="/about" onClick={() => setActiveMenu(null)}>Nosotros</Link>
            <Link className={isActive("/request-a-quote") ? "current" : ""} href="/request-a-quote" onClick={() => setActiveMenu(null)}>Contacto</Link>
          </nav>
      ...
      {open ? (
        <nav className="mobile-nav locale-fixed" aria-label="Navegación móvil">
          <Link href="/" onClick={() => setOpen(false)}>Inicio</Link>
          <Link href="/products" onClick={() => setOpen(false)}>Productos</Link>
          <Link href="/news" onClick={() => setOpen(false)}>Noticias</Link>
          <Link href="/about" onClick={() => setOpen(false)}>Nosotros</Link>
          <Link href="/request-a-quote" onClick={() => setOpen(false)}>Contacto</Link>
